    ...
    <>
      <div className="topbar">
        <div className="topbar-inner">
          ...
          <div className="socials" aria-label="Social links">
            <a href="https://www.facebook.com/share/1CbeTudQ6f/?mibextid=wwXIfr">Facebook</a>
            <a href="https://www.tiktok.com/@maneri.premier.league?_r=1&_t=ZS-95h8v7XZhw5">TikTok</a>
            <a href="https://youtube.com/@maneripremierleague?si=CLwdeXA7aufIUHLZ">YouTube</a>
          </div>
        </div>
      </div>
      ...
      <footer className="site-footer">
        <div className="footer-inner">
          ...
          <span>Proudly powered by Muhammad Hashim Khan</span>
