...
export const REGISTRATION_FIELDS = [
  ...
  { name: "cnicFront", label: "CNIC Front Side", type: "file", required: true, accept: "image/*,.pdf", help: "Upload CNIC front side image or PDF." },
  { name: "cnicBack", label: "CNIC Back Side", type: "file", required: true, accept: "image/*,.pdf", help: "Upload CNIC back side image or PDF." },
...
const REGISTRATION_FIELD_TEXT_UR = {
  ...
  cnicFront: { label: "شناختی کارڈ کا اگلا حصہ", help: "شناختی کارڈ کے اگلے حصے کی تصویر یا PDF اپ لوڈ کریں۔" },
  cnicBack: { label: "شناختی کارڈ کا پچھلا حصہ", help: "شناختی کارڈ کے پچھلے حصے کی تصویر یا PDF اپ لوڈ کریں۔" },
