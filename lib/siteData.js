...
export const TEAM_CARDS = [
  ...
  { code: "/Maneri batoor.PNG", name: "Maneri Baturan", copy: "Powerful local identity with fearless cricket." },
...
export const REGISTRATION_FIELDS = [
  ...
  { name: "experience", label: "Previous Experience", type: "text", required: true, placeholder: "Example: club, school, local cricket", trim: true },
