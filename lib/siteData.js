...
export const REGISTRATION_FIELDS = [
  ...
  { name: "profilePicture", label: "Profile Picture", type: "file", required: true, accept: "image/*", help: "Upload a clear player photo. Max 5MB." },
  { name: "cnicFront", label: "CNIC Front Side", type: "file", required: true, accept: "image/*,.pdf", help: "Upload CNIC front side image or PDF. Max 5MB." },
  { name: "cnicBack", label: "CNIC Back Side", type: "file", required: true, accept: "image/*,.pdf", help: "Upload CNIC back side image or PDF. Max 5MB." },
...
const REGISTRATION_FIELD_TEXT_UR = {
  ...
  profilePicture: { label: "پروفائل تصویر", help: "کھلاڑی کی واضح تصویر اپ لوڈ کریں۔ زیادہ سے زیادہ 5MB۔" },
  cnicFront: { label: "شناختی کارڈ کا اگلا حصہ", help: "شناختی کارڈ کے اگلے حصے کی تصویر یا PDF اپ لوڈ کریں۔ زیادہ سے زیادہ 5MB۔" },
  cnicBack: { label: "شناختی کارڈ کا پچھلا حصہ", help: "شناختی کارڈ کے پچھلے حصے کی تصویر یا PDF اپ لوڈ کریں۔ زیادہ سے زیادہ 5MB۔" },
